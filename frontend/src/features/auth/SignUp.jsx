...
const SignUp = () => {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      // Role for new registrants is always STUDENT which maps to 'user' in frontend
    ...
    <div style={{ 
      ...
      <div style={{ 
        ...
        <p style={{ color: '#6B7280', fontSize: '0.95rem', marginBottom: '2.5rem', fontWeight: '500' }}>
          Join our community for a healthier mind.
        </p>
        ...
        <form onSubmit={handleRegister} style={{ textAlign: 'left' }}>
          <div style={{ marginBottom: '1.25rem' }}>
            <label style={{ display: 'block', fontSize: '0.85rem', fontWeight: '700', color: '#374151', marginBottom: '0.5rem', marginLeft: '0.25rem' }}>Full Name</label>
            <input 
              type="text" 
              name="fullName"
              ...
              disabled={isLoading}
              style={{
                width: '100%', padding: '0.9rem 1.25rem', borderRadius: '14px', border: '1.5px solid #F3F4F6',
                backgroundColor: '#F9FAFB', fontSize: '0.95rem', outline: 'none', transition: 'all 0.2s'
              }}
              onFocus={(e) => { e.target.style.borderColor = DARK_TEAL; e.target.style.backgroundColor = '#FFFFFF'; e.target.style.boxShadow = '0 0 0 4px rgba(6, 78, 59, 0.05)'; }}
              onBlur={(e) => { e.target.style.borderColor = '#F3F4F6'; e.target.style.backgroundColor = '#F9FAFB'; e.target.style.boxShadow = 'none'; }}
            />
          </div>
          ...
          <div style={{ marginBottom: '2rem' }}>
            <label style={{ display: 'block', fontSize: '0.85rem', fontWeight: '700', color: '#374151', marginBottom: '0.5rem', marginLeft: '0.25rem' }}>Confirm Password</label>
            <input 
              type="password" 
          ...
          <button 
            ...
            style={{
              ...
              backgroundColor: DARK_TEAL, color: '#FFFFFF', fontSize: '1rem', fontWeight: '700',
              cursor: 'pointer', transition: 'all 0.2s', boxShadow: '0 4px 12px rgba(6, 78, 59, 0.15)'
            }}
        ...
        <div style={{ margin: '2rem 0', display: 'flex', alignItems: 'center', color: '#9CA3AF' }}>
          ...
          <span style={{ padding: '0 1rem', fontSize: '0.75rem', fontWeight: '600', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Or sign up with</span>
          <hr style={{ flex: 1, border: 'none', borderTop: '1px solid #F3F4F6' }} />
        </div>
        ...
        <p style={{ fontSize: '0.9rem', color: '#6B7280', fontWeight: '500' }}>
          Already have an Account? <Link to="/login" style={{ color: DARK_TEAL, fontWeight: '800', textDecoration: 'none' }}>Login</Link>
        </p>
      </div>
    </div>
  );
